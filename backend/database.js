      ...
      throw err
        ...
        (err) => {
            if (err) {
                ...
                db.run(insert, ["Gas","The subject was a composite of several gas stations Hopper had visited. According to Hopper's wife, the gas station motif was something he had wanted to paint for a long time. Hopper struggled with the painting. He had begun to produce new paintings at a slower rate than before, and had trouble finding suitable gas stations to paint. Hopper wanted to paint a station with the lights lit above the pumps, but the stations in his area only turned the lights on when it was pitch dark outside, to save energy",5,"https://loff.it/wp-content/uploads/2020/01/loffit-edward-hopper-05-600x450.jpg"])
